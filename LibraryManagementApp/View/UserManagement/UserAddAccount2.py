...
class UserAddAccount2App:
    def __init__(self, root, assets_path=None):
        ...
        if assets_path:
            ...
            self.assets_path = self.output_path.parent / Path(r"Ultilities/build/assets/frameUserAddAccount2")
    ...
    def create_main_panel(self):
        ...
        # Load header image
        self.load_image("image_2", (579.0, 129.0))
